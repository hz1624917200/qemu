...
typedef struct generic_prop_fuzz_config {
    const char *arch, *name, *args, *objects, *extra_opts;
	bool append_device;
} generic_prop_fuzz_config;

const generic_prop_fuzz_config prop_fuzz_predefined_configs[] = {
	{
		.arch = "x86_64",
		.name = "virtio-net-pci",
...

	{
		.arch = "x86_64",
		.name = "nvme",
		.args = "-machine q35 -nodefaults -device nvme-ns,drive=disk0,nsid=1 -drive file=null-co://,id=disk0,if=none,format=raw",
		.extra_opts = ",serial=deadbeef",
		.objects = "nvme*",
	},
...

	{
		...
		.extra_opts = ",bmc=bmc",
		.objects = "*ipmi*", .append_device = true,
	},
...

	{
		.arch = "x86_64",
		.name = "ufs",
		.args = "-M q35 -nodefaults -drive file=null-co://,if=none,id=disk0 -device ufs-lu,drive=disk0,bus=ufs_bus",
		.extra_opts = ",id=ufs_bus",
		.objects = "ufs*",
	},
...

	{
		...
		.objects = "tpci200*", .append_device = true,
	},
